            ...
            <tbody>
                ...
                <tr v-for="userInfo in displayedPosts" :key="userInfo.id">
                    ...
                    <td @click="deleteInfo(userInfo.id)">
                        <img class="edit_icon" src="@/assets/img/del_icon.png" alt="삭제 버튼" />
                    </td>
                </tr>
            </tbody>
        </table>
    </div>
    <paging-view :currentPage="currentPage" :totalPages="totalPages" :isEmpty="isEmpty" @changePage="changePage" />
    <modal-confirm :isVisible="dialog.isVisible" :content="dialog.content" @closeDialogHandler="closeDialogHandler" />
    <modal-alert 
